...
public class BlackNum extends RelativeLayout {
    public TextView tv_home_update;
    public TextView tv_home_closeupdate;
    public CheckBox cb_setting_checkBox;

    public BlackNum(Context context) {
        super(context);
        init();
    }

    public BlackNum(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();

    }

    public BlackNum(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        View view = View.inflate(getContext(), R.layout.black_num, this);
