...
public class WatchDog extends RelativeLayout {
    ...
    public WatchDog(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();

    }

    public WatchDog(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        View view = View.inflate(getContext(), R.layout.watch_dog, this);
